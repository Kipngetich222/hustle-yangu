      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Connecting hustlers with opportunities. Empowering communities through local employment.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/jobs/new" className="text-gray-400 hover:text-white transition-colors">
                  Post a Job
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">support@hustlehub.com</span>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400">123 Hustle Street, City, State 12345</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">
            Empowering every hustle, connecting communities, solving unemployment one job at a time.
          </p>
        </div>
      </div>
    </footer>
